...
### Completa aquí
patron = r'\bmidu\b'
resultados = re.finditer(patron, text)
contador = 0
print('Nro.', 'Ocurrencia', 'Inicio', 'Fin')
for indice, resultado in enumerate(resultados):
  print(f'{indice + 1:>4} {resultado.group():>10} {resultado.start():>6} {resultado.end():>3}')
  contador += 1
print('='*30)
print(f'Se encontro {contador} ocurrencia(s)')
...
### Completa aquí
patron = r'\bpython\b'
respuestas = re.finditer(patron, text, flags = re.IGNORECASE)
print('Nro.', 'Ocurrencia', 'Inicio', 'Fin')
for indice, resultado in enumerate(respuestas):
  print(f'{indice + 1:>4} {resultado.group():>10} {resultado.start():>6} {resultado.end():>3}')
print('='*30)
